...
dotnet_base='https://download.visualstudio.microsoft.com/download/pr/'
case ${TARGETARCH} in
...
&& mkdir /ffmpeg \
&& tar -xJf ffmpeg.tar.xz --strip-components=1 -C /ffmpeg "ffmpeg-7.0.2-${TARGETARCH}-static/ffprobe" "ffmpeg-7.0.2-${TARGETARCH}-static/ffmpeg"
EOF
