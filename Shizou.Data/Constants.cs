...
public static class Constants
{
    ...
    public const string SchemeHandlerVersion = "v1.0.0";
    ...
    public const string SchemeHandlerLinuxDownloadUri =
        $"https://github.com/Mik1ll/Shizou/releases/download/SchemeHandler%2F{SchemeHandlerVersion}/SchemeHandler_Linux_x64_{SchemeHandlerVersion}.zip";
}
