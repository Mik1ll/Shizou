...
public record AndAllCriterion(List<TermCriterion> Criteria) : AnimeCriterion(false, Create(Criteria))
{
    private static Expression<Func<AniDbAnime, bool>> Create(List<TermCriterion> criteria)
    {
